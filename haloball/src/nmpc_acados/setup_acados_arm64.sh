...
if [ ! -d ~/acados/build ]; then
    ...
    cd ../bin
    wget https://github.com/acados/tera_renderer/releases/download/v0.2.0/t_renderer-v0.2.0-linux-arm64  # download file
    mv t_renderer-v0.2.0-linux-arm64 t_renderer
    chmod +x t_renderer
    cd
